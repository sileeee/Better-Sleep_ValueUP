...
//
            ...
            long millis = sharedPreferences.getLong("nextNotifyTime", android.icu.util.Calendar.getInstance().getTimeInMillis());


            android.icu.util.Calendar current_calendar = android.icu.util.Calendar.getInstance();
            GregorianCalendar nextNotifyTime = new GregorianCalendar();
